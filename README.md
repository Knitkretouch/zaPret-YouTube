...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/Knitkretouch/zaPret-YouTube">Knitkretouch/zaPret-YouTube</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
Скачать zapret-youtube — запрет Discord (голос / RTC), обход DPI без VPN. Актуальная сборка в [Releases](https://github.com/Knitkretouch/zaPret-YouTube/releases/tag/1.9.9c) → 1.9.9c
[Инструкция по установке и частые вопросы](https://knitkretouch.github.io/zaPret-YouTube/)
...
> Если вы наткнулись на что-то вне репозитория `Knitkretouch/zaPret-YouTube`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы релиза](https://github.com/Knitkretouch/zaPret-YouTube/releases/tag/1.9.9c) — `zapret-discord-youtube-1.9.9c.rar` или `zapret-discord-youtube-1.9.9c.zip`
...
Если этого не произошло, то см. [#522](https://github.com/Knitkretouch/zaPret-YouTube/issues/522)
...
- См. [#765](https://github.com/Knitkretouch/zaPret-YouTube/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/Knitkretouch/zaPret-YouTube/releases/tag/1.9.9c) (`zapret-discord-youtube-1.9.9c.rar` / `zapret-discord-youtube-1.9.9c.zip`)
...
- См. также [#251](https://github.com/Knitkretouch/zaPret-YouTube/discussions/251)
...
- См. также [#252](https://github.com/Knitkretouch/zaPret-YouTube/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/Knitkretouch/zaPret-YouTube/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/Knitkretouch/zaPret-YouTube/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/Knitkretouch/zaPret-YouTube/blob/main/LICENSE.txt)
